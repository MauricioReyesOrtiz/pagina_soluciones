<a href="#" type="button" class="btn btn-sm style-success btn-success" data-toggle="modal"
    data-target="#update-sobrenosotro{{ $sobrenosotro->id }}">
    <i class="fas fa-edit"></i>
</a>
<div id="update-sobrenosotro{{ $sobrenosotro->id }}" class="modal fade" tabindex="-1" role="dialog"
    aria-labelledby="my-modal-title" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header style-warning">
                <h5 class="modal-title" id="my-modal-title">Modificar Sobre Nosotros</h5>
                <button class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="{{ route('sobrenosotro.update', ['id' => $sobrenosotro->id]) }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <div class="form-group"><!--fecha-->
                        <input required type="text" class="form-control form-control-sm" name="fecha" value="{{ $sobrenosotro->fecha }}">
                        <small id="helpId" class="text-muted">Escribir Fecha (campo obligatorio)</small>
                    </div>
                    <div class="form-group"><!--titulo-->
                        <input required type="text" class="form-control form-control-sm" name="titulo" value="{{ $sobrenosotro->titulo }}">
                    ...
                    <div class="md-form form-group col-12"> <!--DESCRIPCION-->
                        ...
                        <textarea id="form10" name="descripcion" class="md-textarea form-control" rows="3" placeholder="{{ $sobrenosotro->descripcion }}"></textarea>
                    ...
                    <img src="{{ asset($sobrenosotro->logo) }}" width="100" height="100" alt="">
