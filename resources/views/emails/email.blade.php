...
<body>
    ...
    <center><h1><strong style="color: rgb(168, 3, 3)">Detalle del Correo SD</strong></h1></center>
    <p><strong>Nombre: </strong> {{$contacto['nombre']}} </p> <!-- Nombre: Mauricio Reyes -->
    <p><strong>Correo Cliente: </strong> {{$contacto['correo_remitente']}} </p> <!-- Correo Remitente: mauricio@correo.autorepuesto.com -->
