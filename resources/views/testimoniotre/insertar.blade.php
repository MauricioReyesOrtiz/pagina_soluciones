<button class="btn btn-warning btn-sm" type="button" data-toggle="modal" data-target="#create-testimoniotre">
    <i class="fa fas-plus"></i> Agregar Comentario Cliente Tres
</button>
<div id="create-testimoniotre" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="my-modal-title"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header style-warning">
                <h5 class="modal-title" id="my-modal-title">Agregar Comentario  Cliente Tres</h5>
                <button class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="{{ route('testimoniotre.store') }}" method="post" enctype="multipart/form-data">
                @csrf
